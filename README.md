...
- Clone o repositório:
 ...
 ``` git@github.com:DSborini/zax_test.git ```
 
- Escolha o motoboy a ser consultado, alterando a variável 'selectedMotoboy' em: src > scripts > motoboyScript.js:

 ``` const selectedMotoboy = 'Moto 4' ```
 
- Abra o arquivo 'index.html' no navegador, as saídas serão exibidas no console, como no exemplo abaixo:

 ``` Moto 4 possui um total de 3 pedidos, das loja(s): Loja 1. Receberá no total o valor de: R$ 13.5. ```
